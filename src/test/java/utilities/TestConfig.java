...
public class TestConfig{
	...
	public static String from = "Shivaji.bajpai@atmecs.com.com";
	public static String password = "Selenium@123";
	public static String[] to ={"VelsSir@gmail.com","SenthilSir.com"};
	public static String subject = "Test Report";
	
	public static String messageBody ="TestMessage";
	public static String attachmentPath="C:\\Users\\Desktop\\Desktop\\devopsimg.jpg";
